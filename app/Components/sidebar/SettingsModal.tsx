...
const handleUpload = (result: any) => {
  const imageUrl = result?.info?.secure_url; // Extract the image URL
  console.log("Uploaded Image URL:", imageUrl); // Log the URL to the console
  setValue('image', imageUrl, { shouldValidate: true });
};

  const onSubmit: SubmitHandler<FieldValues> = (data) => {
    console.log(data); // Log the data being submitted
    setIsLoading(true);
              ...
              <div>
                ...
                <div className="mt-2 flex items-center gap-x-3">
                  <Image 
                    ...
                    alt="Avatar" 
                  />
                  <CldUploadButton options={{ maxFiles: 1 }} onSuccess={handleUpload} 
                onError={handleUploadError}  uploadPreset="o4cn0rl5">
